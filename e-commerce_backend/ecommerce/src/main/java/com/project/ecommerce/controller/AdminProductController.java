...
public class AdminProductController {
	...
	public ResponseEntity<ApiResponse> deleteOrderHandler(@PathVariable Long productId, @RequestHeader("Authorization") String jwt) throws OrderException, ProductException{
