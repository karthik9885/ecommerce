...
public class Product {
	...
	public Product(Long id, String title, String description, int price, int discountedPrice, int discountPercent,
			int quantity, String brand, String color, Set<Size> sizes, String imageUrl, List<Rating> ratings, int numRatings,
	...
	public void setDiscount_percent(int discountPercent) {
		this.discountPercent = discountPercent;
	}
	...
	public String toString() {
		return "Product [id=" + id + ", title=" + title + ", description=" + description + ", price=" + price
				...
				+ ", ratings=" + ratings + ", numRatings=" + numRatings + ", category=" + category + ", createdAt="
				+ createdAt + "]";
	}
